...
In this article we will talk about writing good commit messages not good commits even if these two subject are closely linked. Here is a [good article](https://www.git-tower.com/blog/version-control-best-practices/) from Tobias Günther that summarize well best practices about version control. 
