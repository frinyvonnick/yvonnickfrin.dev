---
title: Create an infinite loading list with React and GraphQL
date: 2019-08-21
tags:
...
**EDIT:** I made an abstraction for the React implementation part called `react-simple-infinite-loading`. You can find out more about the project and how it works in this [article](https://dev.to/yvonnickfrin/infinite-loading-list-component-in-react-431o).
